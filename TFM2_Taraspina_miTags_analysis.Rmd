...
The dataset "Taraspina 18S miTags" contains reads from **45 samples of Tara Oceans** and from **10 samples of Malaspina**. On average, each sample contains 4440 reads:
...
\
In order to keep as many samples as possible, we rarefy at **1154 reads per sample**. By that, we loose 10 samples, and after removing the exluded samples in the 16S dataset (to make them comparable), we end up with a **normalized dataset containing 43 samples and 5684 OTUs**.
...
#the final dimensions of the normalized table are 43 5684.
#5684 + 2958 = 8642
```
\
Datasets summary:
...
Most of the samples take Shannon Index values between 5.5 and 6.5:
...
#load geographical location of stations and sort according to otu_tb18 stations sequence.
...
nrow(tb18_phototrophs)*100/nrow(tb18_ss1154_tax_sorted)
```

Number and proportion (%) of reads of phototrophic groups:

```{r dim_merge2.2, echo=F}
sum(colSums(tb18_phototrophs[,1:43]))
(sum(colSums(tb18_phototrophs[,1:43])))*100/sum(colSums(tb18_ss1154_tax_sorted[,1:43]))
...
(nrow(tb18_non.phototrophs))*100/nrow(tb18_ss1154_tax_sorted)
```

Number and proportion (%) of reads of non-phototrophic groups:

```{r dim_merge3.2, echo=F}
sum(colSums(tb18_non.phototrophs[,1:43]))
(sum(colSums(tb18_non.phototrophs[,1:43])))*100/sum(colSums(tb18_ss1154_tax_sorted[,1:43]))
```
...
ggplot(tb18S_OTUs_reads_samples_rel_abund) +
  ...
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb18S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[A2] METAG 18S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb18S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb18S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[A3] METAG 18S: reads per class vs. OTUs per class",  x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb18S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb18S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[A4] METAG 18S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
nrow(tb18_phototrophs)
nrow(tb18_phototrophs)*100/nrow(tb18_min1154_tax_sorted)
```
...
sum(colSums(tb18_phototrophs[,1:43]))
(sum(colSums(tb18_phototrophs[,1:43])))*100/sum(colSums(tb18_min1154_tax_sorted[,1:43]))
...
nrow(tb18_non.phototrophs)
(nrow(tb18_non.phototrophs))*100/nrow(tb18_min1154_tax_sorted)
```
...
sum(colSums(tb18_non.phototrophs[,1:43]))
(sum(colSums(tb18_non.phototrophs[,1:43])))*100/sum(colSums(tb18_min1154_tax_sorted[,1:43]))
```
...
The dataset "Taraspina 16S miTags" contains reads from **45 samples of Tara Oceans** and from **10 samples of Malaspina**. On average, each sample contains 77920 reads:
...
\
In order to keep as many samples as possible, we rarefy at **36155 reads per sample**. By that, we loose 10 samples, and after removing the exluded samples in the 18S dataset (to make them comparable), we end up with a **normalized dataset containing 43 samples and 19726 OTUs**.
...
Most of the samples take Shannon Index values between 7.0 and 7.4:

```{r shannon_index2_16S, echo=FALSE}
boxplot(tb16_tax_occur_ss36155_div, pch=19, main="TP 16S Shannon's index of diversity",ylab="Shannon's index")
plot(sort(tb16_tax_occur_ss36155_div), pch=19, main="TP 16S Shannon's index of diversity", xlab="sample no.", ylab="Shannon's index")
```
...
plot(sort(OTUs_per_sample_16S_tax_occur_ss36155), pch=19, main="TP 16S no. of OTUs per sample", xlab="sample no.", ylab="no. of OTUs")
boxplot(OTUs_per_sample_16S_tax_occur_ss36155, pch=19, main="TP 16S no. of OTUs per sample", ylab="no. of OTUs")
```
...
plot(sort(pielou_evenness_16S_tax_occur_ss36155), pch=19, main="TP 16S Pielou's index", xlab="sample no.", ylab="Pielou's index")
boxplot(pielou_evenness_16S_tax_occur_ss36155, pch=19, main="TP 16S Pielou's index", ylab="Pielou's index")
```
...
plot(tb16_tax_occur_ss36155_prestonfit, main="TP 16S fit to Preston log-normal model \n(pooled species)")
...
#load geographical location of stations and sort according to otu_tb16 stations sequence.
...
nrow(tb16_phototrophs)*100/nrow(tb16_ss36155_tax_sorted)
```

Number and proportion (%) of reads of phototrophic groups:

```{r dim_merge2.2_16S, echo=F}
sum(colSums(tb16_phototrophs[,1:43]))
(sum(colSums(tb16_phototrophs[,1:43])))*100/sum(colSums(tb16_ss36155_tax_sorted[,1:43]))
...
(nrow(tb16_non.phototrophs))*100/nrow(tb16_ss36155_tax_sorted)
```

Number and proportion (%) of reads of non-phototrophic groups:

```{r dim_merge3.2_16S, echo=F}
sum(colSums(tb16_non.phototrophs[,1:43]))
(sum(colSums(tb16_non.phototrophs[,1:43])))*100/sum(colSums(tb16_ss36155_tax_sorted[,1:43]))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[B1] METAG 16S: reads per class vs. OTUs per class", x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B2] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[B3] METAG 16S: reads per class vs. OTUs per class", x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B4] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[B4.1] METAG 16S: reads per class vs. OTUs per class", x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B4.2] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
\
...
nrow(tb16_phototrophs)
nrow(tb16_phototrophs)*100/nrow(tb16_min36155_tax_sorted)
```

Number and proportion (%) of reads of phototrophic groups:

```{r dim_merge2.2_non.raref_16S, echo=F}
sum(colSums(tb16_phototrophs[,1:43]))
(sum(colSums(tb16_phototrophs[,1:43])))*100/sum(colSums(tb16_min36155_tax_sorted[,1:43]))
...
nrow(tb16_non.phototrophs)
(nrow(tb16_non.phototrophs))*100/nrow(tb16_min36155_tax_sorted)
```

Number and proportion (%) of reads of non-phototrophic groups:

```{r dim_merge3.2_non.raref_16S, echo=F}
sum(colSums(tb16_non.phototrophs[,1:43]))
(sum(colSums(tb16_non.phototrophs[,1:43])))*100/sum(colSums(tb16_min36155_tax_sorted[,1:43]))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B6] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[B7] METAG 16S: reads per class vs. OTUs per class", x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B8] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
\
Absolute values of cyanobacteria groups richness and abundance:
```{r cyanos_abs_values_non.raref_16S, echo=F}
cyano_OTUs_reads
```

```{r cyanos_rel_values_non.raref_16S, echo=F, results="hide"}
#compute relative values
cyano_OTUs_reads_rel_abund <- cyano_OTUs_reads
...
```{r print_rel_values_non.raref_16S, echo=F}
cyano_OTUs_reads_rel_abund[,1:2]
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(OTUs_per_class, reads_per_class)) +
  geom_text_repel(aes(OTUs_per_class, reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 3, box.padding = unit(0.1, "lines"), point.padding = unit(0.02, 'lines')) + labs(title="[B8.2] METAG 16S: reads per class vs. OTUs per class", x="\ndiversity (no. of OTUs in %)", y="abundance (no. of reads in %)\n") + scale_x_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100))  + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
...
ggplot(tb16S_OTUs_reads_samples_rel_abund) +
  geom_point(aes(samples_per_class,reads_per_class)) +
  geom_text_repel(aes(samples_per_class,reads_per_class, label = rownames(tb16S_OTUs_reads_samples)), size=4, force = 8, box.padding = unit(0.1, "lines"), point.padding = unit(0.2, 'lines')) + scale_x_continuous(limits = c(0, 116), breaks=c(25,50,75,100)) + labs(title="[B9.2] METAG 16S: reads per class vs. samples in which they occur", x="\nsamples in which they occurr (%)", y="abundance (no. of reads in %)\n") + scale_y_log10(limits = c(-1,200), breaks = c(0,0.1,1,10,100)) + theme(axis.text=element_text(size=14), axis.title=element_text(size=16))
```
\
