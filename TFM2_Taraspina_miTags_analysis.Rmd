...
``` {r load_data, echo=T, message=FALSE, results="hide", warning=F}
...
tb18S_OTUs_reads_samples$samples_per_class<-c(43,43,39,43,36,43,41,27,39,34,35,21,32,35,16,25,14,18,12,5,4,2,2)
...
```{r merge_tables_non.norm_18S, echo=FALSE, results="hide", warning=F}
tb18_tax_occur_min1154_t<-tb18_tax_occur_min1154_no_cero
...
```{r count_samples_per_group_non.norm_18S, echo=T, warning=FALSE}
#create a table per group and count in how many samples they occur. 
...
```{r aggregate_non.norm_18S, echo=FALSE, results="hide", warning=FALSE}
...
```{r create_table_merging_#OTUs_#reads_#samples_non.norm_18S, echo=FALSE, warning=F}
...
tb18S_OTUs_reads_samples_non.norm$samples_per_class<-c(43,43,41,43,42,43,43,42,39,42,33,41,42,41,37,29,26,26,19,14,13,3,4,2,1)
