...
tb18S_inext<-iNEXT(colSums(tb18_tax_occur_ss1154_no_cero), q=0, datatype = "incidence_raw")
data(spider)
str(spider)

tb18_tax_occur_ss1154_no_cero_t_binary<-ifelse(t(tb18_tax_occur_ss1154_no_cero)>0, 1, 0)
test[1:5,1:5]
tb18S_inext<-iNEXT(t(tb18_tax_occur_ss1154_no_cero_t_binary), q=0, datatype ="incidence_raw")

tb18S_inext<-iNEXT(t(tb18_tax_occur_ss1154_no_cero), q=0, datatype ="incidence_freq")

tb18S_inext<-iNEXT(t(tb18_tax_occur_ss1154_no_cero), q=0, datatype ="abundance")
dim(tb18_tax_occur_ss1154_no_cero_t_binary)
```
...
rarecurve_comparison_list$rarefied_ss1154<-tb18_tax_occur_ss1154_no_cero

#parks.spp <- vector("list") 
#parks.spp$park1 <- park1.spp.abund
#parks.spp$park2 <- park2.spp.abund

rarecurve(t(as.matrix(tb18_tax_occur_ss1154_no_cero)))
tb18_tax_occur_ss1154_no_cero.rarecurve<-rarecurve(t(as.matrix(tb18_tax_occur_ss1154_no_cero)))
head(tb18_tax_occur_ss1154_no_cero.rarecurve)
